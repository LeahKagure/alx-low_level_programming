0. *0* - This function converts a binary number to an *unsigned int*.
...
5. *101* - This function returns the number of bits needed to flip to get from one number to another.
